...
def parse_post_file(md_path: Path) -> Dict[str, Any]:
    ...
    item: Dict[str, Any] = {
        ...
        "tags": [],
        "word_count": 0,
        "content": "",  # only used for category=è¯´è¯´
        "summary": "",
        "top": 0,
    }
    ...
    # âè¯´è¯´âç´æ¥åèå° posts.jsonï¼ä¿æä½ åé»è¾ï¼
...
def build_post_page(
    *,
    ...
    safe_desc = (summary or "è¶.NET - A Geek's Blog").replace('"', "&quot;")
    page_title = f"{title} - è¶.NET" if title else "è¶.NET"
...
<nav id="sidebar">
  ...
  <a href="/" onclick="toggleMenu(true)" class="menu-link"><i class="fa-solid fa-house"></i> é¦é¡µ</a>
  <a href="/#status" onclick="toggleMenu(true)" class="menu-link"><i class="fa-solid fa-feather"></i> å¨æ</a>
  <a href="/#category" onclick="toggleMenu(true)" class="menu-link"><i class="fa-solid fa-folder-open"></i> åç±»</a>
  <a href="/#archive" onclick="toggleMenu(true)" class="menu-link"><i class="fa-solid fa-box-archive"></i> å½æ¡£</a>
  <a href="/#guestbook.md" onclick="toggleMenu(true)" class="menu-link"><i class="fa-solid fa-comment-dots"></i> çè¨æ¿</a>
  <a href="https://status.nkx.moe" target="_blank" class="menu-link"><i class="fa-solid fa-server"></i> ç«ç¹ç¶æ</a>
</nav>
...
<div class="container">
  <header>
    <div class="brand-area">
      ...
      <div style="display:flex; align-items:center;">
        <span class="site-title" onclick="location.href='/'">è¶.NET</span>
    ...
    <nav class="pc-nav">
      ...
      <a href="/#status">å¨æ</a>
      <span class="nav-divider">/</span>
      <a href="/#category">åç±»</a>
      <span class="nav-divider">/</span>
      <a href="/#archive">å½æ¡£</a>
      <span class="nav-divider">/</span>
      <a href="/#guestbook.md">çè¨</a>
      <span class="nav-divider">/</span>
      <a href="https://status.nkx.moe" target="_blank">ç¶æ</a>
    </nav>
  ...
  <div id="article-view">
    <div class="back-btn" onclick="location.href='/'">â è¿ååè¡¨</div>
...
<div id="float-btn-group">
  <div class="float-btn" onclick="window.scrollTo({{top:0, behavior:'smooth'}})" title="é¡¶é¨"><i class="fa-solid fa-arrow-up"></i></div>
</div>
...
<script>
  ...
  function initWaline(path) {{
    ...
    Waline.init({{
      ...
      locale: {{ placeholder: 'æ­¤å¤æ¯æ Markdown è¯­æ³...' }}
    }});
  }}
  ...
  (function loadFooterStats() {{
    ...
    fetch('/posts.json?t=' + Date.now())
      ...
      .then(data => {{
        ...
        const realPosts = data.filter(p => p && p.category !== 'è¯´è¯´');
        let totalWords = 0;
